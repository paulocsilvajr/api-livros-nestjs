...
export class InclusaoTabelasUsuarioAutorLivroLivroUsuario1668022016401 implements MigrationInterface {
    name = 'InclusaoTabelasUsuarioAutorLivroLivroUsuario1668022016401'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "livro" ("id" SERIAL NOT NULL, "titulo" character varying NOT NULL, "resumo" character varying, "numeroPaginas" integer NOT NULL DEFAULT '1', "dataCompra" TIMESTAMP NOT NULL DEFAULT '"2022-11-09T19:26:59.681Z"', "autorId" integer, CONSTRAINT "PK_5601163ea69da49108c4f7854cf" PRIMARY KEY ("id"))`);
