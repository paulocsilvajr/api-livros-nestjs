...
export class tabelasIniciaisAutorLivroUsuarioLivrousuarioTz1670930418252 implements MigrationInterface {
    name = 'tabelasIniciaisAutorLivroUsuarioLivrousuarioTz1670930418252'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "livro" ("id" SERIAL NOT NULL, "titulo" character varying NOT NULL, "resumo" character varying, "numeroPaginas" integer NOT NULL DEFAULT '1', "dataCompra" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "autorId" integer, CONSTRAINT "PK_5601163ea69da49108c4f7854cf" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_f3c07f0aa1c1f2c009bcc709b2" ON "livro" ("titulo", "autorId") `);
        await queryRunner.query(`CREATE TABLE "livro_usuario" ("id" SERIAL NOT NULL, "dataInicioLeitura" TIMESTAMP WITH TIME ZONE NOT NULL, "dataFimLeitura" TIMESTAMP WITH TIME ZONE, "usuarioNome" character varying, "livroId" integer, CONSTRAINT "PK_676043806ff270d93e77a592556" PRIMARY KEY ("id"))`);
